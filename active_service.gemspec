...
# -*- encoding: utf-8 -*-
# stub: active_service 1.5.7 ruby lib

Gem::Specification.new do |s|
  s.name = "active_service".freeze
  s.version = "1.5.7"

  s.required_rubygems_version = Gem::Requirement.new(">= 0".freeze) if s.respond_to? :required_rubygems_version=
  s.require_paths = ["lib".freeze]
  s.authors = ["zwelchcb".freeze]
  s.date = "2020-07-07"
  s.description = "ActiveService is an ORM that maps REST resources to Ruby objects using an ActiveRecord-like interface.".freeze
  s.email = "Zachary.Welch@careerbuilder.com".freeze
  s.extra_rdoc_files = [
    "LICENSE.txt",
    "README.md"
  ]
  s.files = [
    ...
    "lib/active_service/model/attributes/serializer.rb",
    ...
    "lib/active_service/model/params.rb",
    ...
    "spec/model/params_spec.rb",
    "spec/model/parse_spec.rb",
    "spec/model/paths_spec.rb",
    "spec/model/relation_spec.rb",
    "spec/model/serializer_spec.rb",
    "spec/model_spec.rb",
    "spec/spec_helper.rb",
    "spec/support/macros/model_macros.rb",
    "spec/support/macros/request_macros.rb"
  ]
  s.homepage = "http://github.com/zwelchcb/active_service".freeze
  s.licenses = ["MIT".freeze]
  s.rubygems_version = "2.7.6.2".freeze
  s.summary = "An object-relational mapper for web services.".freeze
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_development_dependency(%q<fivemat>.freeze, ["~> 1.2"])
      ...
      s.add_development_dependency(%q<activesupport>.freeze, ["~> 5.0.7"])
      s.add_development_dependency(%q<active_attr>.freeze, ["= 0.12.0"])
      s.add_development_dependency(%q<solargraph>.freeze, ["~> 0.39"])
      s.add_development_dependency(%q<pry-byebug>.freeze, ["~> 3.9"])
      s.add_runtime_dependency(%q<faraday>.freeze, ["< 1.0", ">= 0.8"])
      s.add_runtime_dependency(%q<active_attr>.freeze, ["~> 0"])
    else
      s.add_dependency(%q<rspec>.freeze, ["~> 3.0"])
      s.add_dependency(%q<rspec-its>.freeze, ["~> 1.0"])
      s.add_dependency(%q<simplecov>.freeze, ["~> 0"])
      s.add_dependency(%q<fivemat>.freeze, ["~> 1.2"])
      ...
      s.add_dependency(%q<active_attr>.freeze, ["= 0.12.0"])
      s.add_dependency(%q<solargraph>.freeze, ["~> 0.39"])
      s.add_dependency(%q<pry-byebug>.freeze, ["~> 3.9"])
      s.add_dependency(%q<faraday>.freeze, ["< 1.0", ">= 0.8"])
      s.add_dependency(%q<active_attr>.freeze, ["~> 0"])
    end
  else
    s.add_dependency(%q<rspec>.freeze, ["~> 3.0"])
    s.add_dependency(%q<rspec-its>.freeze, ["~> 1.0"])
